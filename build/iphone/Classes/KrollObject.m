...
@interface URLSyncObject : NSObject
@end

@interface URLSyncObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[URLSyncObject class]])
		{
			for (NSString *key in [[(URLSyncObject*)o modules] allKeys])
			{
