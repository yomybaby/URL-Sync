...
// in simulator we redefine to format for URLSync Developer console
...
{\
	NSString * exceptionName = [@"org.urlsync." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.urlsync";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIURLSyncNativeItemNone = -1, 
	UIURLSyncNativeItemSpinner = -2,
	UIURLSyncNativeItemProgressBar = -3,
	
	UIURLSyncNativeItemSlider = -4,
	UIURLSyncNativeItemSwitch = -5,
	UIURLSyncNativeItemMultiButton = -6,
	UIURLSyncNativeItemSegmented = -7,
	
	UIURLSyncNativeItemTextView = -8,
	UIURLSyncNativeItemTextField = -9,
	UIURLSyncNativeItemSearchBar = -10,
	
	UIURLSyncNativeItemPicker = -11,
	UIURLSyncNativeItemDatePicker = -12,
	
	UIURLSyncNativeItemInfoLight = -13,
	UIURLSyncNativeItemInfoDark = -14,
	
	UIURLSyncNativeItemDisclosure = -15,
	
	UIURLSyncNativeItemContactAdd = -16
};
